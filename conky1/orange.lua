...
gauge = {
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.5,
    graph_fg_colour=0x690E8A,      graph_fg_alpha=0.5,
    hand_fg_colour=0xB52DEB,       hand_fg_alpha=0.0,
    txt_radius=70,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x690E8A,        txt_fg_alpha=1.0,
...
},
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.5,
    graph_fg_colour=0x690E8A,      graph_fg_alpha=0.5,
    hand_fg_colour=0x690E8A,       hand_fg_alpha=0.0,
    txt_radius=46,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x690E8A,        txt_fg_alpha=1.0,
    graduation_radius=28,
...
},
{
    ...
    hand_fg_colour=0x690E8A,       hand_fg_alpha=1.0,
    txt_radius=10,
